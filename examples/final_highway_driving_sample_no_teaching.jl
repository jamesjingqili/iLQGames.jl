...
function player2_belief_mean_update_policy(x,u,τ,π_P_list,π_α_list,u_list,x_list)
    ...
    return - 1/ΔT* x[15]*π_P_list[t][1:2,13]'*inv(I(2)+π_P_list[t][1:2,13]*x[15]*π_P_list[t][1:2,13]') * ( 
        [u[1] - player2_imagined_control_policy(x,τ,1,π_P_list,π_α_list,u_list,x_list);  
        u[2] - player2_imagined_control_policy(x,τ,2,π_P_list, π_α_list,u_list,x_list)] )
end
...
function player3_belief_mean_update_policy(x,u,τ,π_P_list,π_α_list,u_list,x_list)
    ...
    return - 1/ΔT* x[17]*π_P_list[t][1:2,13]'*inv(I(2)+π_P_list[t][1:2,13]*x[17]*π_P_list[t][1:2,13]') * ( 
        [u[1] - player3_imagined_control_policy(x,τ,1,π_P_list,π_α_list,u_list,x_list);
        u[2] - player3_imagined_control_policy(x,τ,2,π_P_list,π_α_list,u_list,x_list)] )
end
...
plot(θ_samples, p1_mean_passive_regret, ribbon=p1_std_passive_regret, label="passive", xlabel="θ", ylabel="regret", color = passive_color, fillalpha = fill_alpha)
plot!(θ_samples, p1_mean_active_regret, ribbon=p1_std_active_regret, label="active", xlabel="θ", ylabel="regret", color = active_color, fillalpha = fill_alpha)
plot!(size = (400,300))
savefig(plot_path*"player1_regret_no_teaching.pdf")
...
plot(θ_samples, p2_mean_passive_regret, ribbon=p2_std_passive_regret, label="passive", xlabel="θ", ylabel="regret", color = passive_color, fillalpha = fill_alpha)
plot!(θ_samples, p2_mean_active_regret, ribbon=p2_std_active_regret, label="active", xlabel="θ", ylabel="regret", color = active_color, fillalpha = fill_alpha)
plot!(size=(400,130), bottom_margin = 3mm)
savefig(plot_path*"player2_regret_no_teaching.pdf")
...
plot(θ_samples, p3_mean_passive_regret, ribbon=p3_std_passive_regret, label="passive", xlabel="θ", ylabel="regret", color = passive_color, fillalpha = fill_alpha)
plot!(θ_samples, p3_mean_active_regret, ribbon=p3_std_active_regret, label="active", xlabel="θ", ylabel="regret", color = active_color, fillalpha = fill_alpha)
plot!(size=(400,130), bottom_margin = 3mm)
savefig(plot_path*"player3_regret_no_teaching.pdf")
