...
for ii in 1:num_clean_traj
    ...
    for jj in 1:num_noise_level
        ...
        conv_table,x0_table,sol_table,loss_table,grad_table,equi_table,iter_table,_ = run_experiment_x0(g,θ₀,[x0_set[ii] + rand(9).*[0,0,0,1,0,0,0,1,0] for kk in 1:num_obs], 
