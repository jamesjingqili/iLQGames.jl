...
initial_state_1 = vcat(initial_state, SVector(initial_belief,initial_belief,1))
...
costs1 = (FunctionPlayerCost((g, x, u, t) -> (10*(x[5]-x[10])^2  + (x[3]-pi/2)^2 + u[1]^2 + u[2]^2 + 50*(x[9]-x[10])^2)), # target lane is x[10], mean of player 2 belief
          FunctionPlayerCost((g, x, u, t) -> (  4*(x[5] - x[1])^2   +(x[7]-pi/2)^2 + u[3]^2 + u[4]^2 ))) 
...
#               1, 0, pi/2, 1,  
#               1, 1, 1) # the last two states are: player 2's belief mean, player 2's belief variance
...
costs3 = (FunctionPlayerCost((g, x, u, t) -> (10*(x[5]-x[10])^2 + 2*(x[4]-1)^2  + u[1]^2 + u[2]^2 + 50*(x[9]-x[10])^2 + 80*x[11]^2 )),
...
costs4 = (FunctionPlayerCost((g, x, u, t) -> (10*(x[5]-x[9])^2  + (x[3]-pi/2)^2 + u[1]^2 + u[2]^2 + 50*(x[9]-x[10])^2 + 80*x[11]^2 )), # target lane is x[10], mean of player 2 belief
          FunctionPlayerCost((g, x, u, t) -> (  4*(x[5]-x[1])^2  + (x[7]-pi/2)^2 + u[3]^2 + u[4]^2 ))) ;
