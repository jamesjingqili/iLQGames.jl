...
nx, nu, ΔT, game_horizon = 4*5, 2*5, 0.1, 40
...
costs = (FunctionPlayerCost((g, x, u, t) -> (  2*(x[1])^2  +  2*(u[1]^2 + u[2]^2) ) - log((x[1]-x[5])^2+(x[2]-x[6])^2)),
         FunctionPlayerCost((g, x, u, t) -> (  2*(x[5])^2  +  4*(x[8]-1)^2 + 2*(u[3]^2 + u[4]^2) ))
         FunctionPlayerCost((g, x, u, t) -> (  2*(x[9])^2  +  2*(u[1]^2 + u[2]^2) )),
         FunctionPlayerCost((g, x, u, t) -> (  2*(x[13]-x[1])^2  +  4*(x[8]-1)^2 + 2*(u[3]^2 + u[4]^2) ))
         FunctionPlayerCost((g, x, u, t) -> (  2*(x[17]-x[9])^2  +  2*(u[1]^2 + u[2]^2) )) 
         )
