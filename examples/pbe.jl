...
# STEP 1: initialize policy, under prior static belief

# the idea is that each player treats the payoff evaluated by substituting the other players control under corresponding actions 
...
# STEP 2: update belief by using initial policy
...
# STEP 3: using the updated belief, update the policy again
...
# STEP 4: update belief by using updated policy
# dynamics in the mind of the first player: iLQR, substituting player 2's control with player 2's varying belief
