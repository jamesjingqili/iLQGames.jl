...
solver1 = iLQSolver(g, max_scale_backtrack=10, max_elwise_diff_step=Inf,max_elwise_diff_converged=0.05, equilibrium_type="OLNE_KKT")
x0 = SVector(1, 1, -pi/2, 0,       1, 0, -pi/2, 0)
converged1, expert_traj1, strategies1 = solve(g, solver1, x0)
...
# get a solver, choose initial conditions and solve (in about 9 ms with AD)
solver2 = iLQSolver(g, max_scale_backtrack=10, max_elwise_diff_step=Inf,max_elwise_diff_converged=0.05, equilibrium_type="FBNE_KKT")
converged2, expert_traj2, strategies2 = solve(g, solver2, x0)
