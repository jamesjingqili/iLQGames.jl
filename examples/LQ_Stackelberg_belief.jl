...
# problem design: the first player has a belief about the second player's state
# the belief is a Gaussian distribution
# the belief is updated by the first player's observation
